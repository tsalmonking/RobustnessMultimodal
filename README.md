...
This script executes the multimodal attack and evaluates the robustness of the Themis model using the provided weights and the evaluation results will be in **`results/`**
